...
public class Clientes {
    ...
    public static void registrarClientes(){
            ...
            //Ya tengo los atributos para crear el objeto, entonces puedo instanciar en el arreglo
    ...
    public static void mostrarCliente() {
     ...
     public static void modificarCliente() {
        JOptionPane.showMessageDialog(null,"Se mostrara la lista de clientes con la posicion podras modificar dicho usuario");
        JOptionPane.showMessageDialog(null,clientesarr);
        int posicion = Integer.parseInt(JOptionPane.showInputDialog(null, "Digta la posicion del cliente que desea modificar"));
     ...
     public static void posicionCliente(int posicion, String nombre, String cedula, String direccion, String telefono, String email) {
